      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-12">
          ...
          <div className="flex gap-4">
            <button
              onClick={handlePrev}
              className="w-12 h-12 rounded-full bg-purple-600/20 border border-purple-500 flex items-center justify-center hover:bg-purple-600/40 transition-all duration-300"
        ...
        <div className="flex gap-8">
          ...
          {displayItems.map((item, index) => (
            <div
              key={item.id}
              className="bg-gray-900/50 rounded-lg overflow-hidden border border-blue-500/30 hover:border-blue-500/60 transition-all duration-300 group cursor-pointer"
            >
              {/* Image */}
