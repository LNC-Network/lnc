    ...
    <Animated>
      <section className="py-24 px-6 text-center bg-primary text-primary-foreground">
        ...
        <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 text-white inline-block">
          ...
          <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 group-hover:bg-zinc-900 transition-colors duration-500">
