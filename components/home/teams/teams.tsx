...
const members = [
  {
    ...
    role: "President",
    avatar:
      "https://media.licdn.com/dms/image/v2/D4E03AQE9HHsSh33ZEA/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1730561072224?e=1762387200&v=beta&t=merEz6ecoOQQ9x2t2WQjTxR9jExzpv7qapRxcEfeliU",
    link: "https://www.linkedin.com/in/rounaq-ansari-4854952ba/",
  },
  {
    name: "Deep Ghosh",
    role: "Vice President",
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
          viewport={{ once: true }}
          className="group max-w-sm h-20 border border-white/30 rounded-md flex justify-center items-center text-white/80 hover:text-white font-light tracking-widest cursor-pointer m-auto mt-10"
          onClick={() => {
            router.push("/team");
          }}
        >
