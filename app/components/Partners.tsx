 ...
 * Partners Component
 * 
 * Displays a grid of partner/technology logos (currently text placeholders).
 * Uses GSAP to animate the header and stagger the entry of the grid items.
 */
export default function Partners() {
    ...
    useGSAP(
        () => {
            // Animate Header: Slide up and fade in
