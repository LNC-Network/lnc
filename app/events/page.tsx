...
export default function EventsPage() {
  ...
  useGSAP(
    ...
    { scope: containerRef, dependencies: [selectedCategory, searchTerm] }
  );
  return (
    <main
      ref={containerRef}
      className="bg-black min-h-screen font-pixel selection:bg-purple-500/30"
    >
      <div className="pt-32 pb-20 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="fade-in text-white/60 text-sm md:text-base font-mono max-w-2xl mx-auto">
            Connect, learn, and build with fellow developers. Filter by category
            or search to find your next adventure.
          </p>
        </div>
          ...
          {filteredEvents.length > 0 ? (
            ...
            <div className="col-span-full flex flex-col items-center justify-center py-20 text-white/40">
              ...
              <button
                ...
                className="mt-4 text-purple-400 hover:underline text-sm uppercase tracking-widest"
              >
                Clear Filters
              </button>
            </div>
